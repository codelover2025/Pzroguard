...
def create_demo_data():
    ...
    managers_data = [
        {'name': 'Sarah Johnson', 'email': 'sarah.johnson@PROGUARD.com', 'dept': 'ATD_WCS_MSE7_MS1', 'team': 'Team Alpha'},
        {'name': 'Michael Chen', 'email': 'michael.chen@PROGUARD.com', 'dept': 'ATD_WCS_MSE7_MS2', 'team': 'Team Beta'},
        {'name': 'Emily Davis', 'email': 'emily.davis@PROGUARD.com', 'dept': 'ATD_WCS_MSE7_MS3', 'team': 'Team Gamma'}
    ]
